...
mixin _$MeetingCreateRequestDto {
 ...
 Uri get url;@JsonKey(name: 'start_at') DateTime? get startAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MeetingCreateRequestDto&&(identical(other.url, url) || other.url == url)&&(identical(other.startAt, startAt) || other.startAt == startAt));
}
...
@useResult
$Res call({
 Uri url,@JsonKey(name: 'start_at') DateTime? startAt
});
...
/// Create a copy of MeetingCreateRequestDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? url = null,Object? startAt = freezed,}) {
...
class _MeetingCreateRequestDto implements MeetingCreateRequestDto {
  const _MeetingCreateRequestDto({required this.url, @JsonKey(name: 'start_at') required this.startAt});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _MeetingCreateRequestDto&&(identical(other.url, url) || other.url == url)&&(identical(other.startAt, startAt) || other.startAt == startAt));
}
...
/// Create a copy of MeetingCreateRequestDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? url = null,Object? startAt = freezed,}) {
