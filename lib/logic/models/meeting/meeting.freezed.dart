...
mixin _$Meeting {
 ...
 String get id; Uri get url;@DateTimeConverter()@JsonKey(name: 'created_at') DateTime get createdAt;@DateTimeConverter()@JsonKey(name: 'start_at') DateTime get startAt;@JsonKey(name: 'meeting_baas_id') String get meetingBaasId; MeetingBotStatus get status;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,url,createdAt,startAt,meetingBaasId,status);
...
@useResult
$Res call({
 String id, Uri url,@DateTimeConverter()@JsonKey(name: 'created_at') DateTime createdAt,@DateTimeConverter()@JsonKey(name: 'start_at') DateTime startAt,@JsonKey(name: 'meeting_baas_id') String meetingBaasId, MeetingBotStatus status
});
...
/// Create a copy of Meeting
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? url = null,Object? createdAt = null,Object? startAt = null,Object? meetingBaasId = null,Object? status = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,url: null == url ? _self.url : url // ignore: cast_nullable_to_non_nullable
as Uri,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,startAt: null == startAt ? _self.startAt : startAt // ignore: cast_nullable_to_non_nullable
as DateTime,meetingBaasId: null == meetingBaasId ? _self.meetingBaasId : meetingBaasId // ignore: cast_nullable_to_non_nullable
...
class _Meeting extends Meeting {
  const _Meeting({required this.id, required this.url, @DateTimeConverter()@JsonKey(name: 'created_at') required this.createdAt, @DateTimeConverter()@JsonKey(name: 'start_at') required this.startAt, @JsonKey(name: 'meeting_baas_id') required this.meetingBaasId, required this.status}): super._();
...
/// Create a copy of Meeting
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? url = null,Object? createdAt = null,Object? startAt = null,Object? meetingBaasId = null,Object? status = null,}) {
