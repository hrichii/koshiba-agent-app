...
mixin _$CalendarEvent {
 ...
 String? get id; String? get title; String? get description; Uri? get url;@DateTimeConverter() DateTime? get startAt;@DateTimeConverter() DateTime? get endAt;
...
@useResult
$Res call({
 String? id, String? title, String? description, Uri? url,@DateTimeConverter() DateTime? startAt,@DateTimeConverter() DateTime? endAt
});
...
class _CalendarEvent extends CalendarEvent {
  const _CalendarEvent({required this.id, required this.title, required this.description, required this.url, @DateTimeConverter() required this.startAt, @DateTimeConverter() required this.endAt}): super._();
...
@override@DateTimeConverter() final  DateTime? endAt;
