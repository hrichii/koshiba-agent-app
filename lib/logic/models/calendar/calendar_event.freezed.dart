...
mixin _$CalendarEvent {
 ...
 String? get id; String? get title; String? get description; Uri? get url;@JsonKey(name: 'start_at')@DateTimeConverter() DateTime? get startAt;@JsonKey(name: 'end_at')@DateTimeConverter() DateTime? get endAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,url,startAt,endAt);
...
@useResult
$Res call({
 String? id, String? title, String? description, Uri? url,@JsonKey(name: 'start_at')@DateTimeConverter() DateTime? startAt,@JsonKey(name: 'end_at')@DateTimeConverter() DateTime? endAt
});
...
/// Create a copy of CalendarEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? title = freezed,Object? description = freezed,Object? url = freezed,Object? startAt = freezed,Object? endAt = freezed,}) {
...
class _CalendarEvent extends CalendarEvent {
  const _CalendarEvent({required this.id, required this.title, required this.description, required this.url, @JsonKey(name: 'start_at')@DateTimeConverter() required this.startAt, @JsonKey(name: 'end_at')@DateTimeConverter() required this.endAt}): super._();
...
@override@JsonKey(name: 'start_at')@DateTimeConverter() final  DateTime? startAt;
@override@JsonKey(name: 'end_at')@DateTimeConverter() final  DateTime? endAt;
...
/// Create a copy of CalendarEvent
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? title = freezed,Object? description = freezed,Object? url = freezed,Object? startAt = freezed,Object? endAt = freezed,}) {
