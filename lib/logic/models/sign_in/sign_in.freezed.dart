...
@RfControl(validators: AppValidation.email) String? get email;@RfControl(validators: AppValidation.password) String? get password;
...
@useResult
$Res call({
@RfControl(validators: AppValidation.email) String? email,@RfControl(validators: AppValidation.password) String? password
});
...
class _SignIn extends SignIn {
  const _SignIn({@RfControl(validators: AppValidation.email) this.email, @RfControl(validators: AppValidation.password) this.password}): super._();
  factory _SignIn.fromJson(Map<String, dynamic> json) => _$SignInFromJson(json);

@override@RfControl(validators: AppValidation.email) final  String? email;
@override@RfControl(validators: AppValidation.password) final  String? password;
