...
mixin _$AccountCreateDto {
  ...
  $AccountCreateDtoCopyWith<AccountCreateDto> get copyWith =>
      _$AccountCreateDtoCopyWithImpl<AccountCreateDto>(
          this as AccountCreateDto, _$identity);
...
abstract mixin class $AccountCreateDtoCopyWith<$Res> {
  factory $AccountCreateDtoCopyWith(
          AccountCreateDto value, $Res Function(AccountCreateDto) _then) =
      _$AccountCreateDtoCopyWithImpl;
  @useResult
...
class _AccountCreateDto extends AccountCreateDto {
  const _AccountCreateDto(
      {required this.uid, required this.email, this.name, this.photoUrl})
      : super._();
  factory _AccountCreateDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AccountCreateDtoCopyWith<_AccountCreateDto> get copyWith =>
      __$AccountCreateDtoCopyWithImpl<_AccountCreateDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AccountCreateDtoToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AccountCreateDtoCopyWith<$Res>
    implements $AccountCreateDtoCopyWith<$Res> {
  factory _$AccountCreateDtoCopyWith(
          _AccountCreateDto value, $Res Function(_AccountCreateDto) _then) =
      __$AccountCreateDtoCopyWithImpl;
  @override
  @useResult
  $Res call({String uid, String email, String? name, String? photoUrl});
}
